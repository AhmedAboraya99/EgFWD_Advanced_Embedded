...
static void GPIOA_Handler(void);
static void GPIOB_Handler(void);
static void GPIOC_Handler(void);
static void GPIOD_Handler(void);
static void GPIOE_Handler(void);
static void GPIOF_Handler(void);

static void TIMER0A_Handler(void);
static void TIMER1A_Handler(void);
static void TIMER2A_Handler(void);
static void TIMER3A_Handler(void);
static void TIMER4A_Handler(void);
static void TIMER5A_Handler(void);
static void WTIMER0A_Handler(void);
static void WTIMER1A_Handler(void);
static void WTIMER2A_Handler(void);
static void WTIMER3A_Handler(void);
static void WTIMER4A_Handler(void);
static void WTIMER5A_Handler(void);
